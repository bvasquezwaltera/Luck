...
import { getCategoryBadgeClassName, statusConfig } from "@/modules/panel/freelancer/deliveries/deliveryStatusConfig";
...
export function DeliveryModuleCard({
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm italic text-slate-600">Cliente: {module.clientName}</p>
