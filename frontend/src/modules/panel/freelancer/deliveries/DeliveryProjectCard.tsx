...
import { getCategoryBadgeClassName } from "@/modules/panel/freelancer/deliveries/deliveryStatusConfig";
...
export function DeliveryProjectCard({
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-sm italic text-slate-600">Cliente: {clientName}</p>
